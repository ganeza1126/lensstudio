...
// @input Component.MaterialMeshVisual frameTopLayerMesh {"showIf": "advanced"}
// @input Component.MaterialMeshVisual frameBackLayerMesh {"showIf": "advanced"}
// @input Component.MaterialMeshVisual lensMesh {"showIf": "advanced"}
// @input Component.MaterialMeshVisual hatPom {"showIf": "advanced"}
...
function setProps() {
  for (var i = 0; i < script.ringObjects.length; i++) {
    var ringImage = script.ringObjects[i].getComponent("Component.Image");
